...
const renderPatterns = (insideExamples, sharedProps) => {
  return (
    <div>
      ...
      <ListBlockButton
        block="pattern__examples"
        icon="lightbulb-o"
        text="Examples"
        {...sharedProps}
      />
      <ListBlockButton
        block="pattern__conversation"
        icon="comments"
        text="Conversation"
        {...sharedProps}
      />
      <ListBlockButton
        block="pattern__center"
        icon="book"
        text="Centered Aside"
        {...sharedProps}
      />
      <ListBlockButton
        block="pattern__watchout"
        icon="exclamation-triangle"
        text="Watch Out Aside"
        {...sharedProps}
      />
      <ListBlockButton
        block="pattern__cultural"
        icon="globe"
        text="Cultural Aside"
        {...sharedProps}
      />
...
const renderInExamples = sharedProps => {
  return (
    <div>
      ...
      />
      <ListItemButton
        data={{ className: "translation" }}
        icon="american-sign-language-interpreting"
        title="Examples Translation"
        {...sharedProps}
      />
    </div>
  );
    ...
    <div className="menu toolbar-menu">
      ...
      <div className="toolbar-menu__left">
        ...
        <ToolbarMenu
          ...
          {...menuProps}
        >
          {Object.entries(Colors).map(([color, colorProps]) => (
            <ColorButton
              color={color}
              key={color}
              title={`${colorProps.title} (${colorProps.hotkey ||
                "No shortcut"})`}
              icon="square"
              {...sharedProps}
            />
